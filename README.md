...
After search result listed, an icon with <img src="./blob/master/attachment.png" width="25" height="25"> means this mail contains attachment, Press 'CTRL' and click, all attachments will be save to disk
